                ...
                <div class="col-lg-6 col-lg-push-3 col-sm-10 col-sm-push-1">
                    <section class="content-inner">
                        ...
                        <blockquote>
                            ...
                            <p>
                                <a class="text-break" target="_blank" href="http://facebook.com/newgenerationdaegu">
                                    NEWGENERATION 페이스북
                                </a>
                            </p>
                            <p>
                                <a class="text-break" target="_blank" href="http://ladmusician.wordpress.com">
                                    NEWGENERATION 기술 블로그
                                </a>
                            </p>
                        </blockquote>
